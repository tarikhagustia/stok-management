	...
	<div class="col-xs-12">
		<div class="box">
			...
			<div class="box-content table-responsive">
				...
				<form action="<?php echo base_url()."index.php/home/salesreport/"; ?>" method="post" class="form-horizontal">
            ...
            <td colspan="6" align="center"><b>Sales Amount</b></td>
