...
if(isset($_POST['submit'])){
	...
	if($hasil){
		...
		?><script language="javascript">document.location.href="?page=nilai&status=0";</script><?php
	}
...
<!-- Content Header (Page header) -->
                  ...
                  <div class="col-xs-12">
                            ...
                            <div class="box">
                                ...
                                <div class="alert alert-info alert-dismissable">
                                    ...
                                    <b>Langkah Kedua!</b> Masukan Nilai Siswa.
                                    </div>
                                    <?php
								}
									?>
      ...
      <br />
        ...
        <form id="mainform" action="home.php?page=nilai_simpan" method="post">
        <table class="table table-bordered">
        <tr>
        ...
        <tr>
            <td colspan="4" align="center"><button name="submit" class="btn">Simpan</button></td>
        </tr>
        </table>
        <!--  end product-table................................... --> 
        </form>
